  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div
        ...
        className="fixed w-96 h-96 bg-gradient-to-r from-indigo-400/30 via-sky-400/20 to-green-400/30  rounded-full blur-3xl pointer-events-none z-0"
      ></div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-6 sm:space-y-8 text-center lg:text-left">
            <div className="space-y-4 sm:space-y-6">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-gray-300 font-light leading-relaxed ax-w-2xl md:max-w-none">
